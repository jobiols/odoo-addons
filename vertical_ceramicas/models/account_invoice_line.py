...
class account_invoice_line(models.Model):
    ...
    def _compute_price(self):
        """ Hereda de la funcion _compute_price que es llamada con un @depends
            cuando cambia la cantidad entre otras cosas el name agregando el
            total de metros o metros cuadrados de producto que hay en al caja.
        """
