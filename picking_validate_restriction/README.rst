...
============================
PICKING VALIDATE RESTRICTION
============================

This module restrict the validation of pickings.
...
Go to the user who need to validate pickings and give permissions.
or go to groups and edit the group Enable validate pickings
